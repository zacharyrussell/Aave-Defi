...
def main():
    ...
    tx = lending_pool.deposit(
        ...
        account.address,
        0,
        {"from": account, "gas_limit": 2074044},
    )
    tx.wait(1)
    print("Deposited!")
    ...
    amount = Web3.toWei(amount_dai_to_borrow, "ether")
...
def get_asset_price(price_feed_address):
    ...
    updated_price = Web3.fromWei(latest_price, "ether")
    print(f"The DAI/ETH price is {updated_price}")
